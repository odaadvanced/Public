...
Slider(
    app, command=red_changed, end=255, width=350, height=50, grid=[1, 0]
).text_size = 30
Text(app, text="Green", grid=[0, 1]).text_size = 30
Slider(
    app, command=green_changed, end=255, width=350, height=50, grid=[1, 1]
).text_size = 30
Text(app, text="Blue", grid=[0, 2]).text_size = 30
Slider(
    app, command=blue_changed, end=255, width=350, height=50, grid=[1, 2]
).text_size = 30
